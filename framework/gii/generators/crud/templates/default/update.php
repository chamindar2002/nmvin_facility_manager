...
$this->menu=array(
	...
	array('label'=>'View', 'url'=>array('view', 'id'=>$model-><?php echo $this->tableSchema->primaryKey; ?>)),
	array('label'=>'Manage', 'url'=>array('admin')),
        array('label'=>'Delete', 'url'=>array('delete', 'id'=>$model-><?php echo $this->tableSchema->primaryKey; ?>)),
);
?>
